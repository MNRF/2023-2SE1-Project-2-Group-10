...
(
IDCardNumber,roleID,firstName,lastName,dateofBirth,gender,cityAddress,streetAddress,zipCode,
email,phoneNumber,contact1Name,contact1phoneNumber,contact2Name,contact2phoneNumber
)
values 
(
@IDCardNumber,@roleID,@firstName,@lastName,@dateofBirth,@gender,@cityAddress,@streetAddress,@zipCode,
